...
CANDIDATE_GROUPS = {
    ...
    "interannual_long_candidate": [4, 5],

    "low_frequency_1369d_candidate": [6],

    "semiannual": [7, 8],

    "interannual_1096d_candidate": [9],

    "annual_secondary_304d": [10, 11],

    "weekly_high_frequency": [12, 13],
}
...
def plot_grouped_reconstruction(
    ...
    fig.suptitle(
        f"{PREFECTURE_CODE} {VARIABLE}: grouped N/2 SSA reconstruction",
        fontsize=16,
    )
...
def save_grouping_definition(
    ...
    grouping_definition = {
        ...
        "note": (
            "Clear adjacent oscillatory pairs were grouped together. "
            "Ambiguous low-frequency components were reconstructed "
            "separately and are not yet merged into a final "
